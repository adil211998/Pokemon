...
const LandingView = ({ navigation, selectedIndex, setSelectedIndex, data }) => {
  const renderPokemon = ({ item, index }) => {
    return (
      <TouchableOpacity onPress={() => navigation.navigate('MyTabs')} style={styles.listWrapper} key={index}>
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Image style={styles.imgStyle} source={require('../../assets/images/intro_1.jpg')} />
        </View>
        <View style={styles.slide2}>
        <Image style={styles.imgStyle} source={require('../../assets/images/intro_2.jpg')} />
        </View>
